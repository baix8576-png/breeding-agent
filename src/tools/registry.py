        ...
        self.register_many(
            [
                ToolManifest(
                    ...
                    stage_scope=["stage_01_intake", "stage_04_domain_blueprint"],
                ...
                ToolManifest(
                    ...
                    stage_scope=["stage_02_retrieval"],
                ...
                ToolManifest(
                    ...
                    stage_scope=["stage_03_tool_bootstrap"],
                    domain_scope=[shared, TaskDomain.BIOINFORMATICS.value, TaskDomain.KNOWLEDGE.value, TaskDomain.SYSTEM.value],
                ),
                ToolManifest(
                    ...
                    stage_scope=["stage_04_domain_blueprint"],
                ...
                ToolManifest(
                    ...
                    stage_scope=["stage_05_resource_and_gate"],
