...
def canonical_pipeline(name: str) -> str:
    ...
    aliases = {
        ...
        "association_mapping_gwas": "association_mapping_gwas",
...
BLUEPRINT_PROFILES: dict[str, dict[str, object]] = {
    ...
    "association_mapping_gwas": {
        "title": "GWAS Association Mapping Blueprint",
        "summary": "Cohort alignment, PLINK2 GLM scan, GWAS metrics, and association report packaging.",
        "sections": [
            "Trait and cohort scope",
            "Association model",
...
def infer_pipeline(paths: list[str]) -> str:
    ...
    if "results/association/gwas/" in joined or "reports/gwas_summary.md" in joined:
        return "association_mapping_gwas"
